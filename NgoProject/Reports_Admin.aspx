...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="login-wrapper">
        <div class="login-frm">
            <form runat="server" style="width: 100%;text-align: center;">
                <a runat="server" style="color: blue; text-decoration: underline; margin: 35px;" href="~/Member_Report.aspx">Members</a>
                <a runat="server" style="color: blue; text-decoration: underline; margin: 35px;" href="~/Donar_Report.aspx">Donars</a>
                <a runat="server" style="color: blue; text-decoration: underline; margin: 35px;" href="~/Fundraise_Report.aspx">Fund raiser</a>
                <a runat="server" style="color: blue; text-decoration: underline; margin: 35px;" href="~/Events_Report.aspx">Events</a>
                <a runat="server" style="color: blue; text-decoration: underline; margin: 35px;" href="~/User_Report.aspx">Users</a>
            </form>
        </div>
    </div>
